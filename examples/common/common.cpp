...
ArgOptions SDGenerationParams::get_options() {
    ...
    options.string_options = {
        ...
        {"",
         "--extra-sample-args",
         "extra sampler/scheduler/guidance args, key=value list. CFG supports guidance_schedule; APG supports apg_eta, apg_momentum, apg_norm_threshold, apg_norm_threshold_smoothing; SLG supports slg_uncond; lcm supports noise_clip_std, noise_scale_start, noise_scale_end; flux supports base_shift, max_shift; ltx2 supports max_shift, base_shift, stretch, terminal; euler_ge supports gamma; cab2 (flow only) supports cab_theta, cab_bootstrap_mix (experimental); beta scheduler supports alpha, beta; logit_normal supports mu, std, logsnr_min, logsnr_max, resolution_aware; lms supports lms_max_order, lms_shift, lms_divisions",
         (int)',',
         &extra_sample_args},
        {"",
         "--extra-tiling-args",
